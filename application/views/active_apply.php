            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                <div class="widget am-cf">
                    <div class="widget-head am-cf">
                        <div class="widget-title am-fl">活动申请</div>
                    </div>
                    <div class="widget-body am-fr">

                        <form class="am-form tpl-form-border-form tpl-form-border-br" action="active/post_apply" method="post">
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label">申请教室 <span class="tpl-form-line-small-title">SEO</span></label>
                                <div class="am-u-sm-9">
                            ...
                            <div class="am-form-group">
                                <label for="user-intro" class="am-u-sm-3 am-form-label">活动细节</label>
                                <div class="am-u-sm-9">
                                    <textarea class="" rows="10" name="details" id="user-intro" placeholder=""></textarea>
                                </div>
                            </div>
